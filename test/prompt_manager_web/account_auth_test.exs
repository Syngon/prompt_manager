defmodule PromptManagerWeb.AccountAuthTest do
  use PromptManagerWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias PromptManager.Accounts
  alias PromptManagerWeb.AccountAuth
  import PromptManager.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PromptManagerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PromptManagerWeb.Endpoint.subscribe(live_socket_id)
